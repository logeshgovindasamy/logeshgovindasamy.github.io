        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="relative aspect-square max-w-sm lg:max-w-md xl:max-w-sm mx-auto rounded-3xl overflow-hidden border border-slate-200/50 dark:border-slate-700/50 shadow-2xl bg-white dark:bg-slate-900 flex items-center justify-center">
              ...
              />
              <div style={{ display: 'none' }} className="absolute inset-0 z-0 items-center justify-center text-slate-400 text-sm">
            ...
            <motion.div
              ...
              className="absolute -top-6 -right-6 glass px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 backdrop-blur-xl bg-white/60 dark:bg-slate-800/60 border border-white/20 dark:border-slate-700"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-6 -left-6 glass px-6 py-3 rounded-2xl shadow-xl flex items-center gap-3 backdrop-blur-xl bg-white/60 dark:bg-slate-800/60 border border-white/20 dark:border-slate-700"
            >
              <span className="text-2xl">☕</span>
              <span className="font-semibold text-slate-800 dark:text-slate-200">Java & React</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
